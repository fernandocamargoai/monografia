\documentclass[relatorio, abnt, nocolorlinks]{inf-ufg}
...
\autor{Fernando Henrique Fernandes de Camargo} % (José da Silva)
\autorR{Camargo, F. H. F. de} % (da Silva, José)

\titulo{Sistema de Auxílio ao Cumprimento de Metas através de Lembretes Automáticos}
\subtitulo{Concepção, implementação e teste}
